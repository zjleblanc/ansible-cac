...
AAP platform self-management: EE builds, backups, certs, and PAH sync helpers.
...
- EE build projects and related credentials / credential types
- AAP //, EE //, and PAH // job templates
- PAH repository sync schedule
